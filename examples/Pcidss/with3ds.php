...
//Psidss step one
try {
    //Generating pcidss order with 3ds card see more https://docs.flitt.com/api/order-parameters-direct/
    $TestOrderData = [
        'order_id' => time(),
    ...
    <table style="margin: auto" border="1">
        ...
        <tr>
            ...
            <td><?php print(\Flitt\Pcidss::get3dsFrom($orderData->getData(), $response_url . '/examples/Pcidss/3dsresult.php')); ?></td>
        </tr>
        </tbody>
    </table>
    </body>

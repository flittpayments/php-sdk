...
//Payment status
try {
    //Generating pcidss order to get status below see more https://docs.flitt.com/api/order-parameters-direct/
    $TestOrderData = [
        'order_id' => time(),

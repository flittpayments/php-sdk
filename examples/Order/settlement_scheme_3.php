...
//Split order
try {
    \Flitt\Configuration::setMerchantId(600001);
    //Generating pcidss order to capture see more https://docs.flitt.com/api/order-parameters-direct/
    $TestOrderData = [
    ...
    $captured_order_data = Flitt\Pcidss::start($TestOrderData); //next order will be captured
    ...
    \Flitt\Configuration::setApiVersion('2.0');
    $url = Flitt\Order::settlement($data);

...
try {
    //Generating pcidss order to get payment token see more https://docs.flitt.com/api/order-parameters-direct/
    $TestOrderData = [
        'order_id' => time(),
    ...
    $Token = Flitt\Pcidss::start($TestOrderData); //next order will be captured
    //Capture request always generated by merchant using host-to-host
    // Required params see more https://docs.flitt.com/api/create-order-recurring/

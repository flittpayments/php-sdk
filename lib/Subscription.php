...
use Flitt\Api\Order as ApiRecurring;
...
class Subscription
{
    ...
    {
        if (\Flitt\Configuration::getApiVersion() !== self::$requiredApiVersion) {
            trigger_error('Reccuring_data allowed only for api version \'2.0\'', E_USER_NOTICE);
            \Flitt\Configuration::setApiVersion(self::$requiredApiVersion);
        }
